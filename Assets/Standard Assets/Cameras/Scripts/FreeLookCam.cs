...
namespace UnityStandardAssets.Cameras
{
    public class FreeLookCam : PivotBasedCameraRig
    {
        ...
        private static FreeLookCam instance;
        ...
        private void HandleRotationMovement()
        {
            ...
            // Read the user input
            var x = CrossPlatformInputManager.GetAxis("Mouse X") * Global.MouseSensitivity;
            var y = CrossPlatformInputManager.GetAxis("Mouse Y") * Global.MouseSensitivity;
        ...
        public static void StaticRestartScene(float delay)
        {            
            instance.RestartScene(delay);
        }
        private void RestartScene(float delay)
        {
            Invoke("RestartSceneNow", delay);
        }
